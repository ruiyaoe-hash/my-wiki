...
| Agent | state/ | knowledge/ | ontology/ | protocol/ | memory/ | event_bus/ | planner/ | executor/ | graphs/ | tests/ | scripts/ | 说明 |
|-------|--------|-----------|-----------|-----------|---------|------------|----------|-----------|---------|--------|----------|------|
...
- event_bus/ 的写权限指 `history/events.jsonl` 落盘；planner/、executor/、tests/、scripts/ 为代码目录，仅 Human 可改 / code directories are Human-writable only.
